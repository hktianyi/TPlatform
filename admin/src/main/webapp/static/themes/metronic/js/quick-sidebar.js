...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        var initChatSlimScroll = function () {
            ...
            var chatMessages = wrapperChat.find('.page-quick-sidebar-chat-member-messages');
            var chatMessagesHeight = chatUsersHeight - wrapperChat.find('.page-quick-sidebar-chat-member-form').outerHeight(true);
        ...
        wrapper.find('.page-quick-sidebar-chat-member .page-quick-sidebar-back-to-list').click(function () {
        ...
        var handleChatMessagePost = function (e) {
            ...
            var chatContainer = wrapperChat.find(".page-quick-sidebar-chat-member-messages");
            var input = wrapperChat.find('.page-quick-sidebar-chat-member-form .form-control');
        ...
        wrapperChat.find('.page-quick-sidebar-chat-member-form .btn').click(handleChatMessagePost);
        wrapperChat.find('.page-quick-sidebar-chat-member-form .form-control').keypress(function (e) {
            if (e.which == 13) {
