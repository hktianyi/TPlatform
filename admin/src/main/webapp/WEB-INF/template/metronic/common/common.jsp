...
<link href="${_PATH}/static/themes/metronic/css/components.min.css" rel="stylesheet" id="style_components" type="text/css"/>
<link href="${_PATH}/static/themes/metronic/css/plugins.min.css" rel="stylesheet" type="text/css"/>
<!-- END THEME GLOBAL STYLES -->
<!-- BEGIN THEME LAYOUT STYLES -->
<link href="${_PATH}/static/themes/metronic/css/layout.min.css" rel="stylesheet" type="text/css"/>
<link href="${_PATH}/static/themes/metronic/css/themes/darkblue.min.css" rel="stylesheet" type="text/css" id="style_color"/>
