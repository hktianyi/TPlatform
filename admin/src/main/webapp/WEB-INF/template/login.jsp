...
<head>
  ...
  <link href="${_PATH}/static/pages/login/login.min.css?${_VERSION}" rel="stylesheet" type="text/css"/>
</head>
<body class="login">
<div id="parallax">
<!-- BEGIN LOGO -->
<div class="logo layer" data-depth="0.6">
  <a href="${_PATH}/index.html">
    <img src="${_PATH}/static/common/img/logo.png" alt="" width="270px"/> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
...
<%@include file="../common/footerWithoutDisInfo.jsp" %>
<script src="${_PATH}/static/plugins/particles.min.js" type="text/javascript"></script>
<script src="${_PATH}/static/pages/login/login.js?${_VERSION}" type="text/javascript"></script>
</body>
</html>