                ...
                <div class="tab-pane active" id="tab_account">
                  <form role="form">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="username" value="${user.username}" disabled="disabled"/></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" placeholder="请填写电子邮箱" class="form-control" name="email" value="${user.email}"/>
                    </div>
                    <div class="form-group">
