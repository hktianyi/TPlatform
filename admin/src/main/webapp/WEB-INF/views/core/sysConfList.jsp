            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" name="Email_Host" value="<conf:conf key="Email_Host"></conf:conf>">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label col-md-3">端口:</label>
                  <div class="col-md-9">
                    <input type="text" class="form-control" name="Email_Port" value="<conf:conf key="Email_Port"></conf:conf>">
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label col-md-3">账号:</label>
                  <div class="col-md-9">
                    <input type="text" class="form-control" name="Email_Username" value="<conf:conf key="Email_Username"></conf:conf>">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label col-md-3">密码:</label>
                  <div class="col-md-9">
                    <input type="password" class="form-control" name="Email_Password" value="<conf:conf key="Email_Password"></conf:conf>">
                  </div>
                </div>
              </div>
            </div>
