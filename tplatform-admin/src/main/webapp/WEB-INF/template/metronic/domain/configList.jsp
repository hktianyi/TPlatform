                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="Email_Host"
                                 value="<t:conf key="Email_Host"></t:conf>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="Email_Port"
                                 value="<t:conf key="Email_Port"></t:conf>">
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="Email_Username"
                                 value="<t:conf key="Email_Username"></t:conf>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input type="password" class="form-control" name="Email_Password"
                                 value="<t:conf key="Email_Password"></t:conf>">
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  $(function () {
    $.getJSON(_PATH + '/config/find/ftpInfo', function (resp) {
